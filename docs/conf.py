# polyclonal documentation build configuration file.
#
...
versionfile = os.path.abspath(
    os.path.join(os.path.dirname(__file__), "../polyclonal/__init__.py")
)
...
htmlhelp_basename = "polyclonaldoc"
...
man_pages = [(master_doc, "polyclonal", "polyclonal Documentation", [author], 1)]
