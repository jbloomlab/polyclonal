...
------------------------------
The docs are hosted on `GitHub pages`_ at https://jbloomlab.github.io/polyclonal
...
First, clone the repo into ``_build/html/``::
    ...
    mkdir _build
    git clone https://github.com/jbloomlab/polyclonal _build/html
...
After a few minutes, your docs should now show up at https://jbloomlab.github.io/polyclonal
